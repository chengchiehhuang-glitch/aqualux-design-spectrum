...
- **設計流派**：Scroll Progress（動態-滾動）
- **代表性視覺**：見主索引縮圖 [m30.webp](../images/thumbs/m30.webp)
- **適合場景**：— 撰寫中 —
- **跟 aqualux 主品牌的關係**：本子頁刻意偏離 aqualux 主紙感、用 Scroll Progress 流派自己的視覺語彙呈現一場虛構的 aqualux 2026 設計光譜展
...
生成 滾動進度指示（Scroll Progress）風格的 single-file HTML demo。
參考 c14 cyberpunk skill 的 8 區段骨架，
但所有視覺語彙改用 Scroll Progress 流派的色票/字型/動態。
