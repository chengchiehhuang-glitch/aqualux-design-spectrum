...
# C 21 · 瑞士國際風格 / Swiss International
...
- **設計流派**：Swiss International（文化在地）
- **代表性視覺**：見主索引縮圖 [c21.webp](../images/thumbs/c21.webp)
- **適合場景**：— 撰寫中 —
- **跟 aqualux 主品牌的關係**：本子頁刻意偏離 aqualux 主紙感、用 Swiss International 流派自己的視覺語彙呈現一場虛構的 aqualux 2026 設計光譜展
...
生成 瑞士國際風格（Swiss International）風格的 single-file HTML demo。
參考 c14 cyberpunk skill 的 8 區段骨架，
但所有視覺語彙改用 Swiss International 流派的色票/字型/動態。
